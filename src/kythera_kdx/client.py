"""
Main client class for interacting with the Kythera API.
"""
...
from .utils import get_api_key_from_env, format_endpoint
    ...
    def _make_request(
        ...
        try:
            ...
            if response.status_code == 401:
                raise KytheraAuthError("Authentication failed. Please check your API key.")
